    ...
    function (e, t, n) {
      ...
      function f(e, t, n) {
        ...
        for (var M = 1; M <= S; M++) {
          ...
          Y && !k && (A += ' qs-event'),
            ...
            (!l && j) || (A += ' qs-num'),
            N && (A += ' qs-active'),
            (c[+L] || t.disabler(L) || (_ && t.noWeekends) || (s && +L < +s) || (o && +L > +o)) &&
              !k &&
              (A += ' qs-disabled'),
      ...
      function m(e, t, n) {
        ...
        ((a.disabled || a.readOnly) && t.respectDisabledReadOnly) ||
          ((t.dateSelected = n ? void 0 : new Date(t.currentYear, t.currentMonth, i)),
                ...
                if (o.contains('qs-num')) {
                  ...
                  if (g) {
                    (s.currentYear = x.getFullYear()),
                      ...
                      u(s);
                    for (
                      var L, Y = s.calendar.querySelectorAll('[data-direction="0"]'), j = 0;
                      !L;
        ...
        var n = (function (e, t) {
          var n,
            ...
            d = (function (e) {
              ...
              d && (l > d && p('min'), i < d && p());
              if (
                (['onSelect', 'onShow', 'onHide', 'onMonthChange', 'formatter', 'disabler'].forEach(
                  function (e) {
